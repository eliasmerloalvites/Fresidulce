...
ALTER TABLE `clase` ADD PRIMARY KEY (`CLA_Id`);

ALTER TABLE `clase` MODIFY `CLA_Id` bigint (20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `categoria` MODIFY `CAT_Id` bigint (20) UNSIGNED NOT NULL AUTO_INCREMENT;

ALTER TABLE `categoria` ADD CONSTRAINT `KFR1` FOREIGN KEY (`CLA_Id`) REFERENCES `clase` (`CLA_Id`) ON DELETE CASCADE;
...
CREATE TABLE
  `producto` (
    ...
    `PRO_PrecioCompra` double(10,2) NOT NULL,
    `PRO_PrecioVenta` double(10,2)  NOT NULL,
...
ALTER TABLE `producto` MODIFY `PRO_Id` bigint (20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
VALUES
  ...
  (
    5,
    '2024_03_17_003058_create_permission_tables',
    1
  );
...
VALUES
  (
    ...
    '2024-03-17 19:20:57',
    b '1',
    'Lista y navega todos los usuarios del sistema',
    'USUARIO'
  ),
  (
    2,
    ...
    '2024-04-06 07:19:07',
    b '1',
    'Ver cualquier dato de un usuario',
  ...
  (
    ...
    '2024-04-06 07:19:28',
    b '1',
    'Editar cualquier dato de un usuario',
    'Edición de usuarios'
  ),
  (
    5,
  ...
  (
    ...
    '2024-04-04 08:45:11',
    b '1',
    'Lista y navega todos los roles del sistema',
    'ROLES'
  ),
  (
    7,
  ...
  (
    ...
    '2024-04-06 20:50:15',
    b '1',
    'Lista y navega todos los permisos del sistema',
    'PERMISOS'
  ),
  (
    12,
    ...
    '2024-04-06 20:51:11',
    b '1',
    'Ver cualquier dato de un permiso',
    'Visualización de detalles de permiso'
  ),
  (
    13,
    'permiso.create',
  ...
  (
    ...
    '2024-04-06 20:53:45',
    b '1',
    'Editar algún dato de un permiso',
    'Edición de permisos'
  ),
  (
    15,
    ...
    '2024-04-06 20:58:28',
    b '1',
    'Eliminar algun registro de permiso',
...
--
INSERT INTO
  `puesto` (`PUE_Id`, `PUE_Nombre`, `PUE_Roles`, `ARE_Id`)
VALUES
...
VALUES
  ...
  (
    ...
    '2024-03-17 17:20:57',
    b '1',
    'Roles unicamente para personal técnico'
  ),
  (
    6,
    'PERSONAL TECNICO 2',
...
VALUES
  (
    1,
    'Elias s Merlo',
    'merloalviteselias@gmail.com',
    NULL,
    '$2y$10$QIRp4TJ1IyW4WHxUZnCd3eOmNqpldLkUUepaedJP/lMcNpIQTQCsa',
    NULL,
    NULL,
    NULL,
    'v6GbOTVXfxpiKud9IFub1q6KIXC5h1J75N6pYz8M0jBYlQZwj0rA5W1tl1Ke',
    '2023-11-02 02:23:21',
    '2024-04-03 22:02:46',
    1,
    '',
  ...
  (
    2,
    'Cielo Menor Saavedra',
    'cmenorsaavedra@gmail.com',
    NULL,
    '$2y$10$dhmXJkshrLc/fyo.99zst.Tsi8WWDA3XsY5BM16MBpYowMva8dtp2',
    NULL,
    NULL,
    NULL,
    '3HzaPl8ZCUKAqVkSGqEcJfMKvPFJeE0Ehm2rp5BPGu6tNTS8vUUVoli2vteD',
    '2024-04-01 23:07:44',
    '2024-04-01 23:07:44',
    1,
    NULL,
  ...
  (
    3,
    'Maria Saavedra Chalan',
    'maria@gmail.com',
    NULL,
    '$2y$10$ABQomQ0BTGNDqv96p78YKupnd7HHEf421iwGiaxEOxyfzuNmbtuFa',
    NULL,
    NULL,
    NULL,
    'qxtZXnDr2S',
  ...
  (
    ...
    'carlos@gmail.com',
    NULL,
    '$2y$10$dpwR75v8GipiCmzFA73iMuGG2cfPRPO0zZQjg5AioZULIpTuMPRm6',
    NULL,
    NULL,
    NULL,
    'M4EbcYXsNMSZV4RkRuJfzOBuaiGslH92SBQwUT2VoKG9t8G6dEDU03sadaty',
    '2024-04-02 06:45:51',
    '2024-04-03 23:22:11',
    1,
    NULL,
  ...
  (
    ...
    'carla@gmail.com',
    NULL,
    '$2y$10$8ZSq.GwYld3nprqw5fNnquVp8IVSBIYMiP.PtQmuUW5PfTNZm9lyG',
    NULL,
    NULL,
    NULL,
    '6h1ylhmzfD',
...
--
ALTER TABLE `actas_personal` ADD PRIMARY KEY (`ACP_Item`, `PER_Id`);

--
-- Indices de la tabla `area`
--
ALTER TABLE `area` ADD PRIMARY KEY (`ARE_Id`);
...
--
ALTER TABLE `contrato_personal` ADD PRIMARY KEY (`COP_Item`, `PER_Id`);
...
--
ALTER TABLE `familiar_personal` ADD PRIMARY KEY (`FAP_Item`, `PER_Id`);
...
--
ALTER TABLE `personal` ADD PRIMARY KEY (`PER_Id`);
...
--
ALTER TABLE `puesto` ADD PRIMARY KEY (`PUE_Id`);
...
--
ALTER TABLE `area` MODIFY `ARE_Id` bigint (20) UNSIGNED NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 12;

--
-- AUTO_INCREMENT de la tabla `asistencia`
--
ALTER TABLE `asistencia` MODIFY `ASI_Id` bigint (20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `personal` MODIFY `PER_Id` bigint (20) UNSIGNED NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 6;
...
--
ALTER TABLE `puesto` MODIFY `PUE_Id` bigint (20) UNSIGNED NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 40;
